...
/*static struct shellcore_patch shellcore_patches_550[] = {
    {0xa57b2e, "\x52\xeb\x08\x66\x90", 5},
    {0xa57b3a, "\xe8\xd2\xfb\xff\xff\x58\xc3", 7},
    {0xa55701, "\x31\xc0\x50\xeb\xe3", 5},
    {0xa576e9, "\xe8\x22\x00\x00\x00\x58\xc3", 7},
    {0x6503f5, "\xeb\x04", 2},
    //{0x26f35c, "\xeb\x04", 2},
    //{0x26f76c, "\xeb\x04", 2},
    {0x584d10, "\xeb", 1},
